...
import { teamCapabilities } from "@/content/extenso-story";
  ...
  return (
    <section id="team" className="section-pad relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 14% 18%, rgba(255,59,0,0.12), transparent 38%), radial-gradient(circle at 85% 76%, rgba(255,255,255,0.05), transparent 42%)",
        }}
      />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.05fr_1.25fr] lg:items-start">
          ...
          >
            ...
            <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/12 bg-white/[0.02] px-4 py-2">
              ...
              <p className="text-xs uppercase tracking-[0.14em] text-zinc-400">Multilingual. Process-driven. Implementation-ready.</p>
            </div>
          </motion.div>
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-white/12 bg-gradient-to-b from-[#171717] to-[#101010] p-6 transition-all duration-200 hover:-translate-y-1 hover:border-white/25 hover:shadow-[0_16px_40px_rgba(0,0,0,0.35)]">
                  <div
                    ...
                    style={{ background: "radial-gradient(circle at 14% 18%, rgba(255,255,255,0.14), transparent 44%)" }}
                  />

                  <div className="relative z-10">
                    <p className="text-[11px] uppercase tracking-[0.14em] text-zinc-500">Capability {String(index + 1).padStart(2, "0")}</p>
